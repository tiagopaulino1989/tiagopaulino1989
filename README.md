...
- [Otimização de Picking na Armazenagem](https://github.com/tiagopaulino1989/otimizacao_combinatoria):
  - Implementação de um modelo de otimização para um problema de estoque por demanda capacitiva de produção.
...
Estou sempre buscando expandir meu conhecimento em áreas como Nuvem, Arquitetura de Software, Analitics, etc.

## 🤝 Colaborações

Se você estiver interessado em colaborar em projetos emocionantes relacionados a [suas áreas de especialização], não hesite em entrar em contato!
